...
SALAD_CATEGORY_FILTER_DIR = path("salad", "salad_category_filter_dir")
SALAD_CATEGORY_FILTER_META_FILE = path("salad", "salad_category_filter_meta_file")
SALAD_CATEGORY_FILTER_THRESHOLD = 0.5
