...
PATHS = {
    ...
    "salad": {
        ...
        "salad_category_filter_dir": PROJECT_ROOT / "results" / "salad_category_filter",
        "salad_category_filter_meta_file": PROJECT_ROOT / "results" / "salad_category_filter" / "meta.json",
